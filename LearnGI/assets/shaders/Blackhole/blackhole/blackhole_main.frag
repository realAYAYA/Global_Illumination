...
uniform float frontView = 1.0;//0.0;
uniform float topView = 0.0;
uniform float cameraRoll = -6.529;//0.0;
...
uniform float adiskHeight = 0.550;//0.2;
uniform float adiskLit = 1.800;//0.5;
uniform float adiskDensityV = 2.0;//1.0;
uniform float adiskDensityH = 4.0;//1.0;
uniform float adiskNoiseScale = 0.800;//1.0;
