...
namespace CppUtil {
	namespace OpenGL {
		class FBO {
		public:
			enum ENUM_TYPE// 选择帧缓冲的构建类型
			{
				ENUM_TYPE_BASIC,			// 基础空类型帧缓冲
				...
				ENUM_TYPE_GBUFFER,			// 延时渲染专用gBuffer
				ENUM_TYPE_RAYTRACING,		// 光线追踪专用FBO
				ENUM_TYPE_RTX,
			};
			enum ENUM_PASS_TYPE {
				ENUM_PASS_COLOR,
...
/*
* 此外，帧缓冲（FBO）是一个高度分化的类型，它本身自带的构造方法中与实际开发中需要的缓存类型想关
*/