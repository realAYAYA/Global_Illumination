...
CppUtil::OpenGL::Camera mainCamera(glm::vec3(0.0f, 0.0f, 10.0f), glm::radians(-1400.0f), glm::radians(180.0f), (GLfloat)SCR_WIDTH / (GLfloat)SCR_HEIGHT, 0.1f, 100, glm::vec3(0, 1.0f, 0), CppUtil::OpenGL::Camera::PROJECTION_PERSEPCTIVE);
#pragma endregion
